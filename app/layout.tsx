...
export const metadata: Metadata = {
  title: "TechNews — developer news in one feed",
  description:
    "Top stories from Hacker News and DEV in a single fast feed. Search, filter by source, and save stories for later.",
};
